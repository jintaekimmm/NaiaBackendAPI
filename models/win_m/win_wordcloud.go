...
func (w *WWordCloud) getListQuery(word []string, count int) map[string]interface{} {
...
func (w *WWordCloud) List(count int) (WordCloudList, error) {
	...
	query := w.getListQuery(word, count)
